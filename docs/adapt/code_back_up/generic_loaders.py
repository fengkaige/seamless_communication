...
class ModelLoader(Generic[ModelT, ConfigT]):
    ...
    def __call__(
        ...
        *,
        ...
        print("="*10, "change file /home/fengkaige/codespace/seamless/venv_seamless/lib/python3.11/site-packages/fairseq2/models/utils/generic_loaders.py  ModelLoader")
        print("替换path为绝对路径")
        print(uri, card.name)
        # >>>>>>>>>>>>
        path_zoo = {
            "https://huggingface.co/facebook/seamless-streaming/resolve/main/seamless_streaming_unity.pt_seamless_streaming_unity" : "/home/fengkaige/codespace/seamless/seamless-streaming-card/seamless_streaming_unity.pt",
            "https://huggingface.co/facebook/seamless-streaming/resolve/main/seamless_streaming_monotonic_decoder.pt_seamless_streaming_monotonic_decoder" : "/home/fengkaige/codespace/seamless/seamless-streaming-card/seamless_streaming_monotonic_decoder.pt",
            "https://dl.fbaipublicfiles.com/seamless/models/vocoder_v2.pt_vocoder_v2" : "/home/fengkaige/codespace/seamless/seamless-streaming-card/vocoder_v2.pt",
        }
        if str(uri) + "_" + str(card.name) in path_zoo.keys():
            path = path_zoo[str(uri) + "_" + str(card.name)]
        else:
...
class TokenizerLoaderBase(ABC, Generic[TokenizerT]):
    ...
    def __call__(
        ...
        *,
        ...
        print("="*10, "change file /home/fengkaige/codespace/seamless/venv_seamless/lib/python3.11/site-packages/fairseq2/models/utils/generic_loaders.py  TokenizerLoaderBase")
        print("替换path为绝对路径")
        print(uri, card.name)
        # import pdb; pdb.set_trace()
        # >>>>>>>>>>>>
        path_zoo = {
            "https://huggingface.co/facebook/seamless-m4t-large/resolve/main/tokenizer.model_seamlessM4T_v2_large" : "/home/fengkaige/codespace/seamless/seamless-streaming-card/tokenizer.model",
            "https://huggingface.co/facebook/seamless-m4t-large/resolve/main/tokenizer.model_seamless_streaming_unity" : "/home/fengkaige/codespace/seamless/seamless-streaming-card/tokenizer.model"
        }
        if str(uri) + "_" + str(card.name) in path_zoo.keys():
            path = path_zoo[str(uri) + "_" + str(card.name)]
        else:
